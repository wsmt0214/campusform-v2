...
public class TestController {
     ...
     */
    @Operation(summary = "프로필 이미지 변경 (테스트)",
            description = "인증 없이 특정 사용자의 프로필 이미지를 변경합니다. `temporary` 프로필에서만 활성화됩니다.", security = {})
    ...
    public UpdateProfileImageResponse testUpdateProfileImage(
            ...
            @Parameter(description = "업로드할 이미지 파일", schema = @Schema(type = "string",
                    format = "binary")) @RequestPart("image") MultipartFile image) {
     ...
     * @param userId 테스트할 사용자 ID
     */
    @Operation(summary = "프로필 이미지 삭제 (테스트)",
            description = "인증 없이 특정 사용자의 프로필 이미지를 삭제합니다. `temporary` 프로필에서만 활성화됩니다.", security = {})
     ...
     */
    @Operation(summary = "닉네임 변경 (테스트)",
            description = "인증 없이 특정 사용자의 닉네임을 변경합니다. `temporary` 프로필에서만 활성화됩니다.", security = {})
