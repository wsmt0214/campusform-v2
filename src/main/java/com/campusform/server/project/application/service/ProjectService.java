...
public class ProjectService {
    ...
    /**
     * 관리자 목록 조회 (관리자만 가능) OWNER는 owner 필드로, ADMIN은 admins 목록으로 반환합니다.
     */
    @Transactional(readOnly = true)
    ...
    /**
     * 포지션 값 치환 규칙 추가·갱신 (기존 매핑 유지, 요청 항목은 동일 fromValue면 toValue만 갱신) 변경된 규칙을 적용해 해당 프로젝트 지원자들의
     * position 컬럼도 함께 갱신한다.
     */
    @Transactional
